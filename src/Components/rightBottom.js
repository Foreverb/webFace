  ...
  render(){
    ...
    <div className='rightBottom'>
        <div className='statusCard'>
            <div className='emjoi' onClick={()=>{this.Display(isClick)}}>
                <img src='https://raw.githubusercontent.com/Foreverb/foreverb.github.io/master/img/emjoi.png' className='Emjoi' alt=''/>
                <Emjoi className={cls_icon}/>
            </div>
            <div className='file'>
            ...
            </div>
            {
              chatModePid !== -1 ? <div className='rtc' onClick={()=>{this.startRtc()}}>
                  <img src='https://raw.githubusercontent.com/Foreverb/foreverb.github.io/master/img/photo.png' className='Rtc' alt=''/>
              </div> : null
            }
        </div>
